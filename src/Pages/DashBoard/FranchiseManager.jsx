...
const FranchiseManager = () => {
    ...
    const confirmStatusChange = async () => {
        if (selectedBike) {
            ...
            try {
                const updatedBike = await Global.httpPost(`/franchisee/update-status/${selectedBike.id}`, { newStatus })
    ...
    return (
        <div className="container mx-auto p-4 font-dm-sans">
            <h1 className="text-2xl font-bold mb-4">Franchise Manager - E-Bike Tracking</h1>
            ...
            <div className="mb-4">
                <Select value={filterStatus} onValueChange={(value) => setFilterStatus(value)}>
                    ...
                    <SelectContent>
                        ...
                        <SelectItem value="AT_FRANCHISEE">At Franchisee</SelectItem>
